...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoReposiotorioDePublicacoes(db)

	publicacaoID, erro := repositorio.CriarPublicacao(publicacao)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func BuscarPublicacoes(w http.ResponseWriter, r *http.Request) {
	...
	publicacoes, erro := repositorio.BuscarPublicacao(usuarioID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possivel atualizar uma publicações que não é sua"))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possivel deletar uma publicações que não é sua"))
		return
	}
